...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7796253868:AAHnxS-o3uCtgMwW0Dj4qGGsNbtvk6RrUeo")
APP_ID = int(os.environ.get("APP_ID", "29547761")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "b67055bfe5d0cab29e31297c453ae9a8") #Your API Hash from my.telegram.org
#--------------------------------------------
...
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://mahatoshubh002:Gutsbot@cluster0.q1ld7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "DbFlash")
#--------------------------------------------
FSUB_LINK_EXPIRY = int(os.getenv("FSUB_LINK_EXPIRY", "0"))  # 0 means no expiry
BAN_SUPPORT = os.environ.get("BAN_SUPPORT", "https://t.me/Weebs_Talk_Station")
TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "200"))
#--------------------------------------------
START_PIC = os.environ.get("START_PIC", "https://i.ibb.co/PGXZ6n49/e56263117eca.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://i.ibb.co/Tx4YfbkN/e064bda1a4f8.jpg")
#--------------------------------------------
